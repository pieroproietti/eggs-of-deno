...
export eggs-of-deno AppImage to the destination host
...
export eggs-of-deno package to the destination host
...
FLAGS
  ...
  -y, --yolk                 force yolk renew
      ...
      --release              release: remove eggs-of-deno, calamares and dependencies after installation
